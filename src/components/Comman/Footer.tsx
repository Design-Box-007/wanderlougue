...
import { navLinks, NavLinksType, socialMedia, SocialMediaLinks } from '@/data/comman';
    ...
    return (
        <footer className='w-full px-5 pb-5 pt-10'>
            <div className='h-auto lg:min-h-[500px] p-2.5 rounded-2xl overflow-hidden relative'>
                <Image src={images.footer} alt='footer-bg' width={1320} height={632} className='w-full h-full brightness-75 object-cover absolute inset-0 z-10' />
                <h2 className='relative z-20 font-poppins font-semibold text-white text-[15vw] text-center'>Wanderlogue</h2>
